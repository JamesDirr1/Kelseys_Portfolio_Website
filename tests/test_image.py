...
def test_image_create_with_defaults():
    ...
    assert img.image_url == "https://static.wixstatic.com/media/0fee66_18f00ad0221142dfbd4c21f7e54d425f~mv2.png/v1/fill/w_549,h_289,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Kelsey_Spade_Header.png"
...
def test_image_load_page_not_found(test_image_client_and_mocks):
    ...
    print(response.data)
    assert response.status_code == 404
    assert b"""<div class="flash-message error">Image ID &#39;3&#39; not found.</div>""" in response.data